            ...
            <div className="text-center lg:text-left space-y-6 lg:space-y-8 order-2 lg:order-1">
              ...
              >
                ...
                <Button 
                  ...
                  variant="outline" 
                  size="lg"
                  className="text-base lg:text-lg px-6 lg:px-8 py-3 lg:py-4 border-2 border-white/30 text-white hover:bg-white/10 backdrop-blur-sm hover:scale-105 transition-all duration-300"
                >
